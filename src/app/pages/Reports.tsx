...
function ReportCard({ title, description, lastGenerated }: { title: string; description: string; lastGenerated: string }) {
  return (
    <div className="bg-white/[0.02] backdrop-blur-md flex-[1_0_0] min-w-[300px] relative rounded-[16px] border border-white/10 hover:border-white/20 hover:-translate-y-1 hover:shadow-[0_8px_30px_rgba(255,255,255,0.04)] transition-all duration-300 group">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[16px] items-start p-[24px] relative w-full">
          ...
          <p className="font-['Archivo:Medium',sans-serif] font-medium leading-[20px] text-[14px] text-[rgba(255,255,255,0.6)]" style={{ fontVariationSettings: "'wdth' 100" }}>
            {description}
          </p>
          <div className="w-full pt-[8px] mt-auto">
            <p className="font-['Archivo:Medium',sans-serif] font-medium leading-[16px] text-[12px] text-[rgba(255,255,255,0.4)] mb-[12px]" style={{ fontVariationSettings: "'wdth' 100" }}>
              Last generated: {lastGenerated}
            </p>
            <button className="bg-white/[0.03] border border-white/10 hover:border-[#928dd3]/50 content-stretch flex gap-2 items-center justify-center px-[16px] py-[10px] relative rounded-[8px] w-full hover:bg-[#928dd3]/10 transition-all duration-300 group/btn">
              <Download size={16} className="text-white/60 group-hover/btn:text-[#928dd3] transition-colors" />
              <p className="font-['Archivo:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[14px] text-white/80 group-hover/btn:text-white whitespace-nowrap transition-colors" style={{ fontVariationSettings: "'wdth' 100" }}>
                Generate Report
              </p>
            </button>
          </div>
...
function PerformanceChart() {
  return (
    <div className="bg-white/[0.02] backdrop-blur-md rounded-[16px] p-[24px] w-full relative border border-white/10 hover:border-white/20 transition-all duration-300 hover:shadow-[0_8px_30px_rgba(255,255,255,0.02)]">
...
function MetricCard({ label, value, change }: { label: string; value: string; change: string }) {
  ...
  return (
    <div className="bg-white/[0.02] backdrop-blur-md flex-[1_0_0] min-w-[200px] relative rounded-[16px] border border-white/10 hover:border-white/20 hover:-translate-y-1 hover:shadow-[0_8px_30px_rgba(255,255,255,0.04)] transition-all duration-300 group">
      <div className="overflow-clip rounded-[inherit] size-full">
