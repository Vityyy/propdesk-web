  ...
  return (
    <div className="relative">
      <button
        ...
        className="bg-black content-stretch flex gap-[12px] items-center justify-between px-[16px] py-[8px] relative rounded-[8px] min-w-[200px] hover:bg-[rgba(255,255,255,0.05)] transition-colors"
      >
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="font-['Archivo:Medium',sans-serif] font-medium leading-[16px] text-[13px] text-[rgba(255,255,255,0.6)]" style={{ fontVariationSettings: "'wdth' 100" }}>
                      {owner.properties} properties · {owner.totalRevenue}/mo
                    </p>
                  </div>
